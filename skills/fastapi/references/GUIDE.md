...
This guide provides comprehensive documentation for the **fastapi** skill in the custom-plugin-python plugin.
...
```bash
# Invoke the skill
claude "fastapi - [your task description]"

# Example
claude "fastapi - analyze the current implementation"
```
...
def implement_fastapi(input_data):
    """
    Implement fastapi functionality.
